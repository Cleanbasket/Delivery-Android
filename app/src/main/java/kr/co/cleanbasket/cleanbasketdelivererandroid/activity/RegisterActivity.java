...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void requestRegistration() {
        ...
        AuthInterface authInterface = RetrofitBase.getInstance().getRetrofit().create(AuthInterface.class);
        ...
        Call<JsonData> call = authInterface.requestJoin(body, etEmail.getText().toString(), etPassword.getText().toString(), etName.getText().toString(), etPhoneNumber.getText().toString(), etBirth.getText().toString());
